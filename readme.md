...
För er som ska bygga Phaser spel / göra tutorials.

Den här länken är en bra start https://blog.ourcade.co/posts/2020/make-first-phaser-3-game-modern-javascript-part1/

Men se till att du byter ut start-templaten och kör https://github.com/ourcade/phaser3-vite-template

Den här videon förklara om du vill köra TS men även hur det funkar med assets. https://www.youtube.com/watch?v=isSXKBcuWxw

Assets kommer från phasers start tutorial.
